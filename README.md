...
> 基于 vnpy 4.1 的开源量化交易框架，专注于图表可视化与策略研发
...
- 📊 **专业图表系统** - 多周期K线图表，支持双图/四图视图
- 📈 **丰富技术指标** - BOLL、SMA、EMA、MACD、RSI、DMI、成交量等基础指标
- 🎯 **策略开发框架** - 完整的策略基类与回测系统
- ⚙️ **配置管理** - 轻量级配置系统，支持环境隔离
- 📝 **完整文档** - 详细的中文文档和教程，适合学习

## 💎 专业版 - ATM Trader Pro

想要更强大的功能？加入知识星球获取 **ATM Trader Pro** 专业版：
...
👉 **[立即加入知识星球「量策堂·AI算法指标策略」](https://t.zsxq.com/FdgVw)** 
...
开源版本采用 MIT 协议，可自由使用和修改。

专业版功能采用商业许可，仅限知识星球会员个人使用。
...
**本项目是《以AI量化为生》和《量化指标解码》系列教程的配套代码，持续更新中...**

如果你想系统性地学习量化交易，从零开始构建自己的交易系统，欢迎关注公众号获取最新教程。

想要获取专业版的完整功能和高级指标，欢迎加入知识星球「量策堂」！
